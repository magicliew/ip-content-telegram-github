...
{hook}。  
有些关系，真的要长大一点才看得懂。  
如果你也是{audience}，你应该会明白这种感觉。你家里有没有一个这样的人？
...
如果你是{audience}，你可能也遇过这种时刻：你明明只是做了一件很小的事，对方嘴上没有夸你，甚至还要念你几句，可是你会感觉到，他其实是开心的。

这就是{role}这个角色最适合被记住的地方。不是每天讲大道理，也不是故意煽情，而是把这些很多人家里都有、但平时没说出口的细节讲出来。
